...
class AppointmentRequestAdapter(private val appointments: List<AppointmentModel>) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val appointmentDateTextView: TextView =
            itemView.findViewById(R.id.appointment_date_text_view)
        private val appointmentTimeTextView: TextView =
            itemView.findViewById(R.id.appointment_time_text_view)
